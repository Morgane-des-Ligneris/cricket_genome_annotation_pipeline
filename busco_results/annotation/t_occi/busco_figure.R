...
my_species <- c('braker2', 'braker2', 'braker2', 'braker2', 'braker2_ab_initio', 'braker2_ab_initio', 'braker2_ab_initio', 'braker2_ab_initio', 'public_annotation', 'public_annotation', 'public_annotation', 'public_annotation')
...
my_percentage <- c(66.5, 6.2, 11.9, 15.4, 6.6, 0.7, 8.7, 84.0, 94.2, 2.1, 1.6, 2.1)
my_values <- c(674, 63, 121, 155, 67, 7, 88, 851, 954, 21, 16, 22)
