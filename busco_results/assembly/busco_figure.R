...
my_species <- c('A_domesticus', 'A_domesticus', 'A_domesticus', 'A_domesticus', 'G_bimaculatus', 'G_bimaculatus', 'G_bimaculatus', 'G_bimaculatus', 'L_kohalensis', 'L_kohalensis', 'L_kohalensis', 'L_kohalensis', 'T_occipitalis', 'T_occipitalis', 'T_occipitalis', 'T_occipitalis', 'T_oceanicus', 'T_oceanicus', 'T_oceanicus', 'T_oceanicus')
...
my_percentage <- c(43.9, 1.1, 38.7, 16.3, 96.6, 2.3, 0.5, 0.6, 95.8, 3.2, 0.6, 0.4, 95.1, 2.2, 1.3, 1.4, 90.6, 1.9, 5.4, 2.1)
my_values <- c(445, 11, 392, 165, 979, 23, 5, 6, 970, 32, 6, 5, 963, 22, 13, 15, 918, 19, 55, 21)
